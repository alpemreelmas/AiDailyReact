document.querySelector(function(){
    ...
    document.querySelector('.sparkbar').sparkline('html', { type: 'bar' });

    document.querySelector('.sparkline-pie').sparkline('html', {
        type: 'pie',
        offset: 90,
        width: '100px',
        height: '100px',
    ...
    document.querySelector('.knob').knob({
		draw: function () {
		}
    }); 
    document.querySelector(".rtl .knob").knob({
		draw: function () {
		   //style rtl
			this.i.css({
...
document.querySelector(function() {
    ...
    document.querySelector('#minibar-chart1').sparkline(values2[0], paramsBar);
    document.querySelector('#minibar-chart2').sparkline(values2[1], paramsBar);
    document.querySelector('#minibar-chart3').sparkline(values2[2], paramsBar);
    document.querySelector('#minibar-chart4').sparkline(values2[3], paramsBar);
